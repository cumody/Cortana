...
import com.mahmoudshaaban.cortana.Model.Cart;
import com.mahmoudshaaban.cortana.Model.Products;
import com.mahmoudshaaban.cortana.Prevelant.Prevalent;
import com.mahmoudshaaban.cortana.ViewHolder.CartViewholder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txttotalamount = findViewById(R.id.text_price);
        ...
        FirebaseRecyclerOptions<Cart> options =
                new FirebaseRecyclerOptions.Builder<Cart>()
                        .setQuery(cartlistRef.child("User View")
                                .child(Prevalent.currentOnlineU.getPhone())
