...
import com.mahmoudshaaban.cortana.ViewHolder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNameTextView.setText(Prevalent.currentOnlineU.getAddress());


        Picasso.get().load(Prevalent.currentOnlineU.getImage()).placeholder(R.drawable.profile).into(profileimageview);
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cart) {
            Intent intent = new Intent(HomeActivity.this,CartActivity.class);
            startActivity(intent);        } else if (id == R.id.nav_orders) {
